      ...
      "calls": [
        {
          ...
          "result": "{\"address\": \"33xx Signal Hill Heights SW\", \"district\": \"west\", \"lat\": 51.0207, \"lon\": -114.1573, \"roll_number\": \"091-44-218-03\", \"assessed_value\": 985000, \"land"
        },
        {
      ...
      "calls": [
        {
          ...
          "args": "profile=gse_on",
          "result": "[lender profile -> gse_on] point $999,000 -> $999,000 (unchanged); range $988,000–$1,010,000 -> $988,000–$1,010,000; confidence MODERATE 0.72 -> MODERATE 0.72; "
        },
        {
          "name": "rerun_widening",
          "args": "extra_tier=True",
          "result": "[forced wider search (min_comp_count=6)] point $999,000 -> $999,000 (unchanged); range $988,000–$1,010,000 -> $988,000–$1,010,000; confidence MODERATE 0.72 -> L"
        },
        {
          "name": "recompute_dropping_comp",
          "args": "comp_id=C-A",
          "result": "[dropping comp C-A] point $999,000 -> $999,000 (unchanged); range $988,000–$1,010,000 -> $988,000–$1,010,000; confidence MODERATE 0.72 -> MODERATE 0.72; selecte"
        }
      ]
    }
  }
