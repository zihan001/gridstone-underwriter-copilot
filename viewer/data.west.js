...
window.MEMO = (function () {
  ...
  "narrative": {
    "scope": "This appraisal establishes a market value range for 33xx Signal Hill Heights SW as of June 1, 2026, using sales comparison methodology. The subject property is located in Calgary's west district with an assessed value of $985,000. Analysis draws from Open Calgary data for the subject property and synthetic comparable sales generated by the deterministic engine.",
    "selection": "The engine retrieved 9 potential comparables and selected 4 for analysis after rejecting 5. Rejections included: C-E (405 days stale), C-G (East district non-adjacent after widening), C-F and C-H (outlier pricing at 3.1 and 7.6 MAD low respectively), and C-I (duplicate of C-A). The final comparable set spans 2 tiers, with 3 same-district sales (C-A, C-B, C-C) in tier 0 and 1 adjacent-district sale (C-D) in tier 1.",
    "adjustment": "Gross adjustment percentages ranged from 4.0% to 7.3%, with net adjustments from -4.9% to 7.2%. C-A received 4.0% net adjustment, C-B received 6.7% net adjustment, C-C received -4.9% net adjustment despite 7.0% gross adjustments, and C-D received 7.2% net adjustment. Adjusted values range from $983,187 to $1,011,695. Time adjustments for C-D utilized city-wide fallback series due to lack of encoded district benchmark.",
    "reconciliation": "The weighted analysis produced adjusted values of $999,569 (C-A, 43.58% weight), $983,187 (C-B, 23.03% weight), $1,008,361 (C-C, 20.65% weight), and $1,011,695 (C-D, 12.74% weight). The reconciled range spans $988,000 to $1,010,000 with a point estimate of $999,000, representing a 2.2% spread. Weight allocation reflects proximity, recency, and reliability factors with highest weighting assigned to C-A.",
    "confidence": "Confidence scores MODERATE at 0.7238. Positive contributors include comparable count (+0.08), adjusted-value spread (+0.125), recency (+0.0382), and distance (+0.0345). Negative factors include adjustment burden (-0.0039) and widening depth (-0.10). The analysis required tier-2 relaxation to achieve minimum comparable count, degrading the recency distribution and reducing overall confidence.",
    "limiting": "Four flags require commentary: DEEP_WIDENING necessitated tier-2 relaxation with confidence penalty; STALE_COMP affects C-D beyond 120-day watch threshold; ADJACENT_DISTRICT_COMP introduces location risk for C-D managed through distance-weighting; UNSUPPORTED_TIME_ADJ for C-D creates approximation risk in time adjustments. The 2.2% value spread and moderate confidence band reflect these analytical constraints while supporting the concluded range."
  },
  "agentTrace": {
    "intake": {
      "source": "llm",
