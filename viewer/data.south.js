      ...
      "calls": [
        {
          ...
          "result": "{\"address\": \"84xx Bonaventure Drive SE\", \"district\": \"south\", \"lat\": 50.9583, \"lon\": -114.054, \"roll_number\": \"074-21-335-07\", \"assessed_value\": 687500, \"land_u"
        },
        {
      ...
      "calls": [
        {
          ...
          "args": "profile=gse_on",
          "result": "[lender profile -> gse_on] point $716,000 -> $716,000 (unchanged); range $708,000–$724,000 -> $708,000–$724,000; confidence MODERATE 0.69 -> MODERATE 0.69; sele"
        },
        {
          "name": "rerun_widening",
          "args": "extra_tier=True",
          "result": "[forced wider search (min_comp_count=6)] point $716,000 -> $716,000 (unchanged); range $708,000–$724,000 -> $708,000–$724,000; confidence MODERATE 0.69 -> LOW 0"
        },
        {
          "name": "recompute_dropping_comp",
          "args": "comp_id=C-A",
          "result": "[dropping comp C-A] point $716,000 -> $716,000 (unchanged); range $708,000–$724,000 -> $708,000–$724,000; confidence MODERATE 0.69 -> MODERATE 0.69; selected 4 "
        }
      ]
    }
  }
