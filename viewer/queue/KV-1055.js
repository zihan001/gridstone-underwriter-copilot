...
window.MEMO = (function () {
  ...
  "narrative": {
    "scope": "This appraisal develops a market value range for 15xx 7th Street NE in the north_east district as of June 1, 2026. The subject property has an assessed value of $548,000. The sales comparison approach employs synthetic comparable sales generated by a deterministic engine, with the subject property grounded in Open Calgary data. Analysis encompasses comparable selection, adjustment protocols, and confidence assessment to support underwriting decisions.",
    "selection": "The engine retrieved 5 comparable sales and selected all 5 for analysis, with no rejections recorded. All selected comparables are located within the same north_east district as the subject. The final tier reached was 2, indicating the engine required tier-2 relaxation to achieve minimum comparable count thresholds. This deeper search pattern triggered the DEEP_WIDENING flag, noting that recency distribution degraded during the widening process with a corresponding -0.10 confidence penalty applied.",
    "adjustment": "Gross adjustment percentages range from 0.7% to 4.9% across the comparable set, with net adjustments ranging from 0.6% to 2.0%. Comparable S-C exhibits the lowest adjustment burden at 0.7% gross and net, while S-E shows the highest gross adjustment at 4.9% but nets to only 0.6%. All comparables utilized city-wide fallback time adjustment series due to insufficient district-specific benchmarks, as flagged under UNSUPPORTED_TIME_ADJ. Additionally, S-E exceeded the 120-day recency threshold, triggering STALE_COMP flag with corresponding weight reduction applied.",
    "reconciliation": "Adjusted comparable values range from $550,853 to $560,825, producing a tight cluster with minimal dispersion. Weighting reflects adjustment quality and recency, with S-A receiving the highest weight at 0.2748 and S-E the lowest at 0.0943 due to staleness penalties. The weighted analysis yields a value range of $552,000 to $561,000, representing a 1.62% spread. The point estimate of $556,500 falls centrally within this range, demonstrating balanced comparable influence.",
    "confidence": "The analysis achieves a MODERATE confidence score of 0.7964. Positive confidence drivers include comparable count (+0.11), tight adjusted-value spread (+0.1395), reasonable recency (+0.0444), proximity (+0.042), and low adjustment burden (+0.0105). The primary detractor is the widening depth penalty (-0.10) from tier-2 relaxation requirements. The combination of adequate comparable support offset by search depth concerns supports the moderate confidence classification.",
    "limiting": "This appraisal is subject to several limiting conditions that require disclosure. The UNSUPPORTED_TIME_ADJ flag indicates time adjustments rely on city-wide rather than district-specific benchmarks, introducing approximation in temporal corrections. The DEEP_WIDENING flag reflects relaxed selection criteria to meet count requirements, potentially affecting comparable quality. One comparable exceeds preferred recency thresholds as noted in STALE_COMP. These conditions are factored into the confidence assessment but warrant consideration in final underwriting decisions."
  }
};
