...
window.MEMO = (function () {
  ...
  "narrative": {
    "scope": "This appraisal analyzes the subject property at 51xx Lake Bonavista Drive SE in Calgary's south district as of June 1, 2026. The analysis employs a sales comparison approach using synthetic comparable transactions generated from Open Calgary data. The subject carries an assessed value of $712,000. The appraisal establishes a market value range through systematic comparable selection, adjustment analysis, and weighted reconciliation methods.",
    "selection": "The comparable selection process retrieved 5 potential transactions and selected all 5 for analysis, with 0 rejections recorded. All selected comparables (F-A through F-E) are classified as tier 0 properties located within the same south district as the subject. The selection achieved full utilization of available comparable data with no secondary tier properties required, indicating robust primary market evidence for the subject property type and location.",
    "adjustment": "Adjustment analysis reveals moderate adjustment burdens across the comparable set. Gross adjustment percentages range from 0.9% (F-C) to 3.0% (F-E), while net adjustments span from -0.3% (F-E) to 1.5% (F-A). The net adjustment spread of 1.8 percentage points demonstrates reasonable comparability. Notable adjustment patterns include F-D showing significant gross-to-net adjustment compression (1.7% to 0.1%) and F-E requiring the highest gross adjustments while achieving a modest negative net position.",
    "reconciliation": "The weighted reconciliation process assigns varying weights based on comparable quality metrics: F-A receives the highest weight at 0.2663, followed by F-B at 0.2363, F-C at 0.207, F-D at 0.1626, and F-E at 0.1278. Adjusted values range from $727,917 to $752,226, producing a final value range of $731,500 to $751,500 with a point estimate of $741,500. The 2.7% spread between range bounds reflects moderate value precision.",
    "confidence": "The analysis achieves a HIGH confidence band with a score of 0.8864. Primary confidence drivers include comparable count contribution (0.11), adjusted-value spread contribution (0.1125), and recency contribution (0.0498). Distance and adjustment burden factors contribute 0.042 and 0.0221 respectively, while widening depth shows zero contribution, indicating no secondary tier reliance. No threshold flags were triggered during the analysis process.",
    "limiting": "This appraisal relies on synthetic comparable transactions derived from Open Calgary data rather than verified market transactions. The analysis assumes data accuracy and market representativeness of the synthetic transactions. The effective date of June 1, 2026 represents a future valuation date. Market conditions, regulatory changes, or property-specific factors occurring after the analysis date could materially affect actual market value. The value range methodology acknowledges inherent valuation uncertainty and should be interpreted within appropriate confidence intervals."
  },
  "agentTrace": {
    "intake": {
      "source": "llm",
      "reasoning": "## Subject Record\n\n**Property Identity & Assessment:**\n- Address: 51xx Lake Bonavista Drive SE\n- Roll Number: 074-22-118-04\n- District: South\n- Coordinates: 50.961, -114.0612\n- Assessed Value: $712,000 (2026 assessment year)\n- Land Use: R-C1\n\n**Physical Characteristics:**\n- GLA: 1,560 sq ft (from listing)\n- Lot Size: 5,500 sq ft (from listing)\n- Bedrooms (AG): 3 (from listing)\n- Full Baths: 2 (from listing)\n- Half Baths: 1 (from listing)\n- Year Built: 1988 (grounded from Open Calgary)\n- Basement Finished: 600 sq ft (from listing)\n- Basement Walkout: Not specified (no district typical available)\n- Garage Type: Attached (from listing)\n- Garage Stalls: 2 (from listing)\n\n**Intake Reasoning:**\nThe property was successfully grounded through Open Calgary using the Lake Bonavista Drive SE address, establishing the roll number, district classification (south), and year built (1988). The listing provided comprehensive physical details including square footages, bedroom/bathroom counts, basement finishing, and garage specifications. Only the basement walkout feature was not mentioned in the listing, and no district-typical value was available for this field in the south district. All other required fields were either grounded from official records or explicitly stated in the listing text.",
      "calls": [
        {
