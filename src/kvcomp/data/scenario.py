...
def _spec() -> list[dict]:
    ...
    return [
        ...
        dict(cid="C-A", mls="C-2208", district=District.SOUTH, contract=date(2026, 4, 11),
        ...
        dict(cid="C-B", mls="C-2156", district=District.SOUTH, contract=date(2026, 2, 19),
        ...
        dict(cid="C-C", mls="C-2241", district=District.SOUTH, contract=date(2026, 3, 6),
        ...
        # --- tier-1 adjacent district (South East), stale-ish -> SELECTED w/ flags ---
        dict(cid="C-D", mls="C-2089", district=District.SOUTH_EAST, contract=date(2026, 1, 8),
        ...
        dict(cid="C-E", mls="C-1804", district=District.SOUTH, contract=date(2025, 4, 22),
        ...
        dict(cid="C-F", mls="C-2233", district=District.SOUTH, contract=date(2026, 3, 29),
        ...
        # G: West district, not adjacent to South -> WRONG_DISTRICT_AFTER_WIDENING
        dict(cid="C-G", mls="C-2170", district=District.WEST, contract=date(2026, 2, 14),
        ...
        dict(cid="C-H", mls="C-2195", district=District.SOUTH, contract=date(2026, 3, 12),
        ...
        dict(cid="C-I", mls="C-7741", district=District.SOUTH, contract=date(2026, 4, 11),
             gla=1485, lot=5350, beds=3, full=2, half=1, bsmt=600, walkout=False,
             gar=GarageType.ATTACHED, stalls=2, built=1985, cond=Condition.C3, qual=Quality.Q3,
             duplicate_of="C-A"),
    ]
...
def generate_universe(subject: Subject, cfg: AdjustmentConfig | None = None,
    ...
    for s in _spec():
        ...
        comp = build_comp(
            ...
            comp_id=s["cid"], label=f"COMP-{s['cid'][-1]}", mls=s["mls"], district=s["district"],
        )
